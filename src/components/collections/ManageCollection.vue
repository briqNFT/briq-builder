...
const validate = async () => {
    console.log('totoro', await backendManager.post('v1/admin/starknet-testnet/ducks_everywhere/validate_new_nft', {
        token_id: tokenId.value,
        data: jsonData.value?._data?.serialize(),
...
<template>
    ...
    <div class="container m-auto py-8">
        ...
        <div class="my-8 py-4">
            ...
            <div>
                For validation: autogenerated attributes
