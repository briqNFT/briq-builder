...
const setupWorld = async () => {
    ...
    const txes = [
        ...
        { contractAddress: addr.setup_world, entrypoint: 'register_set_contract', calldata:[addr.world, addr.set_nft_1155_fren_ducks , 1] },
        ...
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: ['ERC1155OperatorApproval', addr.booklet_fren_ducks] },
        ...
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: ['ERC1155OperatorApproval', addr.set_nft_1155_fren_ducks] },
        ...
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: ['ERC1155Balance', addr.booklet_fren_ducks] },
        ...
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: ['ERC1155Balance', addr.set_nft_1155_fren_ducks] },

    //{ contractAddress: addr.world, entrypoint: 'grant_writer', calldata: ['ERC721Balance', addr.set_nft_1155_lil_ducks] },
    //{ contractAddress: addr.world, entrypoint: 'grant_writer', calldata: ['ERC721Balance', addr.set_nft_1155_fren_ducks] },
