...
const setupWorld = async () => {
    ...
    const txes = [
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('WorldConfig'), addr.setup_world] },
    ...
    // New Argent X Wallet
        ...
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('BriqFactoryStore'), addr.briq_factory] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155OperatorApproval'), addr.briq_token] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155OperatorApproval'), addr.box_nft_sp] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155OperatorApproval'), addr.box_nft_briqmas] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155OperatorApproval'), addr.booklet_ducks] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155OperatorApproval'), addr.booklet_starknet_planet] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155OperatorApproval'), addr.booklet_briqmas] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155OperatorApproval'), addr.booklet_ducks_frens] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155OperatorApproval'), addr.set_nft] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155OperatorApproval'), addr.set_nft_ducks] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155OperatorApproval'), addr.set_nft_sp] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155OperatorApproval'), addr.set_nft_briqmas] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155OperatorApproval'), addr.set_nft_1155_ducks_frens] },

        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155Balance'), addr.briq_token] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155Balance'), addr.box_nft_sp] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155Balance'), addr.box_nft_briqmas] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155Balance'), addr.booklet_ducks] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155Balance'), addr.booklet_starknet_planet] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155Balance'), addr.booklet_briqmas] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155Balance'), addr.booklet_ducks_frens] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155Balance'), addr.set_nft] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155Balance'), addr.set_nft_ducks] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155Balance'), addr.set_nft_sp] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155Balance'), addr.set_nft_briqmas] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC1155Balance'), addr.set_nft_1155_ducks_frens] },

        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721Balance'), addr.set_nft] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721Balance'), addr.set_nft_ducks] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721Balance'), addr.set_nft_sp] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721Balance'), addr.set_nft_briqmas] },

        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721Owner'), addr.set_nft] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721Owner'), addr.set_nft_ducks] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721Owner'), addr.set_nft_sp] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721Owner'), addr.set_nft_briqmas] },

        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721OperatorApproval'), addr.set_nft] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721OperatorApproval'), addr.set_nft_ducks] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721OperatorApproval'), addr.set_nft_sp] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721OperatorApproval'), addr.set_nft_briqmas] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721TokenApproval'), addr.set_nft] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721TokenApproval'), addr.set_nft_ducks] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721TokenApproval'), addr.set_nft_sp] },
        { contractAddress: addr.world, entrypoint: 'grant_writer', calldata: [shortString.encodeShortString('ERC721TokenApproval'), addr.set_nft_briqmas] },
    ];
