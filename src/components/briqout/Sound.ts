...
import ballLostSource from '@/assets/briqout/audio/ballLost.mp3?url';
...
export async function useBriqoutAudio() {
    ...
    const ballLostBuffer = await loadAudioBuffer(ctx, ballLostSource);
    ...
    return {
        ...
        ballLost: () => playSound(ctx, ballLostBuffer),
    };
}
