<template>
    <div>
        ...
        <Btn v-bind="$attrs" @click="undo" :disabled="!canUndo" class="w-8 ml-1" tooltip="Undo (Ctrl + Z)">
            <p><i class="fas fa-undo"/></p>
        </Btn>
        <Btn v-bind="$attrs" @click="redo" :disabled="!canRedo" class="w-8 mr-1" tooltip="Redo (Ctrl + Shift + Z)">
