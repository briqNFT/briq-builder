...
<template>
    <div class="mx-1 mt-1 sm:mx-2 sm:mt-2 flex flex-wrap pointer-events-none" v-if="!inputStore.hideInput">
        <div class="flex-1 basis-1 min-w-max flex justify-stretch lg:justify-start">
            <div class="flex flex-none items-center p-1 gap-1 border border-grad-lighter bg-grad-lightest rounded pointer-events-auto">
        ...
        <div class="flex-1 basis-1 flex lg:justify-center">
            <div class="border border-grad-lighter bg-grad-lightest rounded flex gap-1 p-1 pointer-events-auto">
        ...
        <div class="flex-1 basis-1 flex lg:justify-end">
            <div v-if="booklet" class="rounded bg-grad-lighter border mr-2 flex justify-center items-center p-1 pointer-events-auto">
                <Btn no-background :force-active="!minimized" @click="minimized = !minimized"><i class="far fa-book-open"/></Btn>
            </div>
            <div class="flex items-stretch gap-1 p-1 border  border-grad-lighter bg-grad-lightest rounded pointer-events-auto">
