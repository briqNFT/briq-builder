...
<template>
    <div class="absolute bottom-0 right-0 p-2 text-white">
        <a target="_blank" href="https://briqnft.notion.site/briqnft/briq-hub-ae6a1d92745044cc9c2274251a5212f3">
            <h5
                v-if="CONF.theme === 'realms'"
                class="text-[4rem] font-bold drop-shadow-lg px-4 py-6 alpha-pill briq-logo flex flex-col items-center leading-[3rem]">
            ...
            <h5 v-else="" class="text-[4rem] font-bold drop-shadow-lg px-4 py-6 alpha-pill briq-logo">briq</h5>
        </a>
    </div>
</template>
