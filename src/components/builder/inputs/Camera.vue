                ...
                <div class="overflow-visible">
                    <div class="absolute left-0 top-0 h-10 flex gap-0.5 w-full">
                        ...
                        <div class="flex flex-col gap-0.5">
                            <Btn
                                v-if="editing === preset.name" :disabled="!isValidName(editingName)" @click="doneRenaming(true)" @keypress.enter="doneRenaming(true)"
                                class="flex justify-center items-center min-h-0 h-5 text-sm leading-none">
                            ...
                            <Btn v-if="editing === preset.name" @click="doneRenaming(false)" class="flex justify-center items-center min-h-0 h-5 text-sm leading-none"><i class="fa-solid fa-arrow-rotate-left"/></Btn>
                            <Btn v-else="" @click="deletePreset(preset)" class="flex justify-center items-center min-h-0 h-5 text-sm leading-none"><i class="fa-solid fa-ban"/></Btn>
                        </div>
                    </div>
                </div>
            </div>
