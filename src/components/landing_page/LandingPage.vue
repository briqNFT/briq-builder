                ...
                <div class="centerall flex-1">
                    ...
                    <div class="alpha-pill py-4 px-3">
                        <Btn @click="$router.push({ name: 'Builder' })">
                            <span class="px-4 py-1 inline-block">Build</span>
                        </Btn>
                    </div>
                </div>
        ...
        <div class="bg-grad-light my-20 row">
            <div class="flex flex-wrap justify-between">
                ...
                <div class="md:centerright centerall flex-initial">
                    ...
                    <p>
                        briqs can be combined to create NFTs called sets.<br>
        ...
        <div class="row bg-grad-light my-20">
            <div class="flex flex-wrap justify-between">
                <div class="centerall md:centerleft flex-initial">
                    ...
                    <p>
                        briqs and sets can be used in any game and can be interpreted as you see fit.<br>
